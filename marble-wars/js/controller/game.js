define(['view/gameView', 'model/marbles', 'controller/audio', 'model/effects', 'controller/challenge', 'constants'], function(Game, Marbles, Audio, Effects, Challenge, Constants) {  
  ...
  function onbrag_(mode, stage) {
    ...
    var linkUrl = Constants.linkPageBase() + "?gamedata=" + challengeString;
    ...
    console.log('brag on google plus, ' + prefilltext);
  }
