define(['view/gameView', 'model/marbles', 'controller/audio', 'model/effects', 'controller/challenge'], function(Game, Marbles, Audio, Effects, Challenge) {  
  ...
  function onbrag_(mode, stage) {
    console.log('brag on google plus, mode: ' + mode + ', stage: ' + stage);
    return Challenge.generate(mode, stage);
  }
